    ...
    <div style={style.div}>
      ...
      <center><form style={style.formContainer} className="form-container">
        <div className="form-group" style={style.inputForms}>
          <label>Name:</label>
          <input type="text" className="form-control" id="fullName" placeholder="First and Last Name"></input>
        ...
        <div className="form-group" style={style.inputForms}>
          <label>Message:</label>
          <textarea className="form-control" id="exampleFormControlTextarea1" rows="5" placeholder="Write your message here..."></textarea>
